...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 w-full flex items-center justify-between px-6 md:16 lg:px-36 py-5'>
            ...
            max-md:justify-center gap-8 md:px-8
            py-3 max-md:h-screen md:rounded-full backdrop-blur 
